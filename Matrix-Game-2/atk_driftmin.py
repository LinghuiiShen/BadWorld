...
class FirstFramePGDAttack:
    ...
    def sample_timestep_tensor(self, num_latent_frames: int) -> Tuple[torch.Tensor, int, float]:
        """
        为当前 3-frame block 采样一个随机 diffusion timestep
        """
    ...
    def run_attack_forward_once(
        ...
        # ============================================================
        # loss:
        # Minimize the difference between pred_v and the ground-truth velocity that "returns to the first-frame latent"
        #
        # ground truth velocity:
        #   v_gt = x0(noisy target latent) - x1(context first-frame latent); gradient descent
        #
        ...
        # gt_velocity_target = target_x1 - noisy_target                         # [1,16,T,44,80]
    ...
    def attack(self):
        ...
        for step in range(1, self.args.num_steps + 1):
            ...
            with torch.no_grad():
                # minimize objective：gradient descent
